	...
	<div class="row-fluid">
		...
		<div class="span3">
			...
			<div class="data_list">
				...
				<div class="datas">
					<ul>
						<c:forEach var="diaryDateCount" items="${diaryDateCountList }">
							<li><span><a href="main?s_releaseDateStr=${diaryDateCount.releaseDateStr}">${diaryDateCount.releaseDateStr }(${diaryDateCount.diaryCount })</a></span></li>
						</c:forEach>
					</ul>
				</div>
			</div>
