			...
			<div class="span8">
				<form action="user?action=save" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">
					<table width="100%">
						...
						<tr>
							<td>个人昵称:</td>
							<td><input type="text" id="nickName" name="nickName" style="margin-top: 5px;height: 30px" value=${currentUser.nickName }></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><button class="btn btn-primary" type="button" onclick="javascirpt:history.back()">返回</button>&nbsp;&nbsp;<font id="error" style="color:red">${error }</font></td>
						</tr>
					</table>
				</form>
			</div>
